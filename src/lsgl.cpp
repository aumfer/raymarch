...
void lsgl::compileshader(GLuint shader, const char *src, int length) {
...
void lsgl::linkprogram(GLuint program) {
...
GLint lsgl::checkprogram(GLuint program) {
	GLint is_valid;
